...
<%@page import="com.dt95.entity.Userinfo"%>
<%@page import="com.dt95.dao.impl.SelectImpl"%>
<%@page import="com.dt95.dao.Select"%>
...
<div id="container">
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <li><a href='#'>${ll.newstitle }
      </a><span><fmt:formatDate value="${ll.releasetime }" pattern="yyyy-MM-dd"/> </span>
      </li>
      
      </c:forEach>
        <%-- <li class='space'></li>
        <p align="right">当前页数:[${now }/${numpage }]&nbsp; 
      <a href="FitterServlet?moment=1">首页</a>
      <a href="FitterServlet?moment=${pg.currentPage-1}">上一页</a>
      <a href="FitterServlet?moment=${pg.currentPage+1}">下一页</a>
       <a href="FitterServlet?moment=${pg.lastPage}">末页</a> </p> --%>
      </ul>
